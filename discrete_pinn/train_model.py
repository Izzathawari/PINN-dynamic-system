...
def plot_predictions(model, datasets, save_filename="output_dir/pinn_predictions.png"):
    ...
    offset = 0
    for split_name, split_color, (observed, predicted) in zip(
        split_names, split_colors, split_predictions
    ):
...
def train():
    ...
    x_trajectory = logistic_map.run_trajectory(initial_val=0.5, transient_state=100, steady_state=200)
    ...
    for epoch in pbar:
        ...
        total_loss = criterion(x_curr, x_pred, x_next, model.r)
